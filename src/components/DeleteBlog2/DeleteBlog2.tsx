...
export default function DeleteBlog2() {
  const { id } = useParams();
        ...
        <div className="fixed top-32 z-10 mx-auto p-6">
          ...
          >
            ...
            <div className="mt-2 mb-4 text-sm">
              על מנת למחוק את הבלוג יש ללחוץ על כפתור מחק , פעולה זו תמחק את
              נתוני הבלוג באופן סופי . לביטול מחיקת הבלוג יש ללחוץ לחצן "בטל
              פעולה" שיחזיר למצב קודם.
            </div>
