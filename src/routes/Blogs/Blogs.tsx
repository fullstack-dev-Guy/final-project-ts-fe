          ...
          <div className="mx-auto max-w-screen-xl py-8 px-4 lg:py-16 lg:px-6">
            <div className="mx-auto mb-6 max-w-screen-sm text-center lg:mb-6">
              ...
              <p className="font-light text-gray-500 dark:text-gray-400 sm:text-xl">
                כאן תוכלו לרשום את הבלוג שלכם או את חוויית הביקור שהיתה לכם
                אצלנו , על מנת לרשום תוכן יש צורך להרשם ולהתחבר למערכת. לאחר מכן
                תוכלו לערוך או למחוק את התוכן הכתוב
              </p>
            </div>
